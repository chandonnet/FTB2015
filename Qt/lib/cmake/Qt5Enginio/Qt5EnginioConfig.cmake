...
set(Qt5Enginio_VERSION_STRING 1.1.2)
...
macro(_populate_Enginio_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Enginio_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5Enginio_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_Enginio_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/Enginio/1.1.2"
        "${_qt5Enginio_install_prefix}/include/Enginio/1.1.2/Enginio"
    )
    ...
    foreach(_module_dep ${_Qt5Enginio_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.1.2 ${_Qt5Enginio_FIND_VERSION_EXACT}
    ...
    _populate_Enginio_target_properties(RELEASE "Qt5Enginio.dll" "Qt5Enginio.lib" )



    _populate_Enginio_target_properties(DEBUG "Qt5Enginiod.dll" "Qt5Enginiod.lib" )
