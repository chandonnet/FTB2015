...
set(Qt5WebEngineWidgets_VERSION_STRING 5.4.2)
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.4.2"
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.4.2/QtWebEngineWidgets"
    )
    ...
    set(_Qt5WebEngineWidgets_MODULE_DEPENDENCIES "WebEngine;Quick;Widgets;Gui;Network;Core")
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.2 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
    ...
    set(_Qt5WebEngineWidgets_LIB_DEPENDENCIES "Qt5::WebEngine;Qt5::Quick;Qt5::Widgets;Qt5::Gui;Qt5::Network;Qt5::Core")
