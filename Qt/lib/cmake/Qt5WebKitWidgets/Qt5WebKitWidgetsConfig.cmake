...
set(Qt5WebKitWidgets_VERSION_STRING 5.4.2)
...
macro(_populate_WebKitWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5WebKitWidgets_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_WebKitWidgets_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::WebKitWidgets)
    ...
    set(Qt5WebKitWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKitWidgets_install_prefix}/include/QtWebKitWidgets/5.4.2"
        "${_qt5WebKitWidgets_install_prefix}/include/QtWebKitWidgets/5.4.2/QtWebKitWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5WebKitWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.2 ${_Qt5WebKitWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebKitWidgets_target_properties(RELEASE "Qt5WebKitWidgets.dll" "Qt5WebKitWidgets.lib" )



    _populate_WebKitWidgets_target_properties(DEBUG "Qt5WebKitWidgetsd.dll" "Qt5WebKitWidgetsd.lib" )
    ...
    macro(_populate_WebKitWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKitWidgets_install_prefix}/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKitWidgets_check_file_exists(${imported_location})
