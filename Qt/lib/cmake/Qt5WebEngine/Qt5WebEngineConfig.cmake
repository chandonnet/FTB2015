...
set(Qt5WebEngine_VERSION_STRING 5.4.2)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.4.2"
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.4.2/QtWebEngine"
    )
    ...
    set(_Qt5WebEngine_MODULE_DEPENDENCIES "Quick;Gui;Qml;Core")
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.2 ${_Qt5WebEngine_FIND_VERSION_EXACT}
    ...
    set(_Qt5WebEngine_LIB_DEPENDENCIES "Qt5::Quick;Qt5::Gui;Qt5::Qml;Qt5::Core")
