...
set(Qt5WebKit_VERSION_STRING 5.4.2)
...
macro(_populate_WebKit_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5WebKit_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_WebKit_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/QtWebKit/5.4.2"
        "${_qt5WebKit_install_prefix}/include/QtWebKit/5.4.2/QtWebKit"
    )
    ...
    foreach(_module_dep ${_Qt5WebKit_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.2 ${_Qt5WebKit_FIND_VERSION_EXACT}
    ...
    _populate_WebKit_target_properties(RELEASE "Qt5WebKit.dll" "Qt5WebKit.lib" )



    _populate_WebKit_target_properties(DEBUG "Qt5WebKitd.dll" "Qt5WebKitd.lib" )
